...
3. [公開ドキュメント](https://kooraseru.github.io/Template/)と[コントリビューションガイド](../.github/CONTRIBUTING.md)を確認します。
...
<table>
  <tr><td><a href="../.github/CONTRIBUTING.md"><code>.github/CONTRIBUTING.md</code></a></td><td>コントリビューターのワークフローを定義します。</td></tr>
  <tr><td><a href="../.github/SECURITY.md"><code>.github/SECURITY.md</code></a></td><td>脆弱性を非公開で報告する方法を定義します。</td></tr>
